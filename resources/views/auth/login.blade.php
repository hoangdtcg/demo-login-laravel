...
<body>
<div id="logreg-forms">
    <form class="form-signin" method="post" action="{{route('customLogin')}}">
        @csrf
{{--        {{ csrf_token() }}--}}
        <h1 class
        ...
        <input type="text" name="email" id="inputEmail" class="form-control @error('email') is-invalid @enderror" placeholder="Email address" autofocus="">
